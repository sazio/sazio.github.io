...
Hello! I'm currently a PhD Candidate at the Vision Institute and Ecole Normale Superieure in Paris, under the supervision of [Ulisse Ferrari](https://scholar.google.it/citations?user=89XheA0AAAAJ&hl=it), [Olivier Marre](http://oliviermarre.free.fr/) and [Peter Neri](https://sites.google.com/site/neripeter/). My research interests are centered around uncovering the underlying principles and symmetries that allow for invariant and stable representations, with a focus on understanding biological learning, and in particular vision. More precisely, to investigate invariance and equivariance properties at the level of the retina, I'm currently setting up my main project on investigating what could be plausible low-level mechanisms/inductive biases relevant for segmentation at later stages. 

Previously, I worked as a Research Engineer in [Brice Bathellier](https://www.bathellier-lab.org/people/Brice)'s Lab at the [Hearing Institute](https://www.institut-audition.fr/en) (Institut Pasteur), focusing on nonlinear network models for the auditory system. I also worked on data conversion and visualization techniques for the ROOT framework at CERN (with [Lorenzo Moneta](https://root.cern/about/team/#Lorenzo%20Moneta)) and nonlinear models of spatial memory at the University of Ottawa, under the supervision of [André Longtin](https://mysite.science.uottawa.ca/alongtin/) and [Leonard Maler](https://www.uottawa.ca/brain/people/maler-leonard).
